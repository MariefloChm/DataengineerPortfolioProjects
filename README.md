...
*Consulter le script SQL de crétion de base de données et d'insertion de données:* **[HERE](SQL_creation_BDD)**<br />
*Consulter le script SQL d'analyse de données:* **[HERE](...............)**<br />
